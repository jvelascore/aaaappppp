...
#define UART_BAUD_RATE	9600	// Baud Rate 9600
//#define UART_FLOW_CONTROL  UART_FLOW_CONTROL_ON  /* _ON or _OFF */
#define UART_FLOW_CONTROL  UART_FLOW_CONTROL_OFF  /* _ON or _OFF */	// Luis - Flow control off
 ...
 *   TX pin = P3.4     RX pin = P3.5     */
  ...
  */
  #define UART_TX_PORT_NUM  3    // UART TX P3.3
  #define UART_TX_BIT_NUM   3    
  #define UART_RX_PORT_NUM  3    // UART RX P3.4
  #define UART_RX_BIT_NUM   4
