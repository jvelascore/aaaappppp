...
const digioConfig pinSHT75_SCK = {PIN_SHT75_SCK_PORT, PIN_SHT75_SCK_PIN, PIN_SHT75_SCK_BITMASK, PIN_SHT75_SCK_DIR,  PIN_SHT75_SCK_INIT_VAL};
const digioConfig pinSHT75_SDA = {PIN_SHT75_SDA_PORT, PIN_SHT75_SDA_PIN, PIN_SHT75_SDA_BITMASK, PIN_SHT75_SDA_DIR,  PIN_SHT75_SDA_INIT_VAL};
const digioConfig pinAnemometro = {PIN_ANEMOMETRO_PORT, PIN_ANEMOMETRO_PIN, PIN_ANEMOMETRO_BITMASK, PIN_ANEMOMETRO_DIR,  PIN_ANEMOMETRO_INIT_VAL};
const digioConfig pinVeleta = {PIN_VELETA_PORT, PIN_VELETA_PIN, PIN_VELETA_BITMASK, PIN_VELETA_DIR,  PIN_VELETA_INIT_VAL};
...
#if ((PIN_SHT75_SCK_PORT == __mrfi_GDO0_PORT__) && (PIN_SHT75_SCK_PIN == __mrfi_GDO0_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO0."
#endif

#if ((PIN_SHT75_SCK_PORT == __mrfi_GDO2_PORT__) && (PIN_SHT75_SCK_PIN == __mrfi_GDO2_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO2."
#endif

#if ((PIN_SHT75_SDA_PORT == __mrfi_GDO0_PORT__) && (PIN_SHT75_SDA_PIN == __mrfi_GDO0_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO0."
#endif

#if ((PIN_SHT75_SDA_PORT == __mrfi_GDO2_PORT__) && (PIN_SHT75_SDA_PIN == __mrfi_GDO2_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO2."
#endif

#if ((PIN_ANEMOMETRO_PORT == __mrfi_GDO0_PORT__) && (PIN_ANEMOMETRO_PIN == __mrfi_GDO0_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO0."
#endif

#if ((PIN_ANEMOMETRO_PORT == __mrfi_GDO2_PORT__) && (PIN_ANEMOMETRO_PIN == __mrfi_GDO2_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO2."
#endif

#if ((PIN_VELETA_PORT == __mrfi_GDO0_PORT__) && (PIN_VELETA_PIN == __mrfi_GDO0_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO0."
#endif

#if ((PIN_VELETA_PORT == __mrfi_GDO2_PORT__) && (PIN_VELETA_PIN == __mrfi_GDO2_BIT__))
  #error "ERROR:  El pin GPIO que estás intentando configurar se usa para GDO2."
#endif
...
void BSP_InitDigio(void)
{
  ...
  BSP_ConfigDigio(&pinSHT75_SCK);
  BSP_ConfigDigio(&pinSHT75_SDA);
  BSP_ConfigDigio(&pinAnemometro);
  BSP_ConfigDigio(&pinVeleta);
  PIN_VELETA_PxSEL |= PIN_VELETA_BITMASK; // El pin de la veleta es ANALOG INPUT, no DIGIO
