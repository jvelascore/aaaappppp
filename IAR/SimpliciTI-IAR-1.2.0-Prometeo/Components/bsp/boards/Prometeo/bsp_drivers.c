...
#include "bsp_digio.h"  // XXX-albarc añadir interrupción externa
...
#if (!defined BSP_NO_DIGIO) // XXX-albarc añadir interrupción externa
  BSP_InitDigio();
#endif
}
...
#if (!defined BSP_NO_DIGIO)   // XXX-albarc añadir interrupción externa
#include "drivers/code/bsp_digio.c"
#endif

#if (!defined BSP_NO_SENSORS)   // XXX-albarc añadir medidas sensores
#include "drivers/code/bsp_sensors.c"
#endif
